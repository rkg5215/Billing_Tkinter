...
def time():
    string = datetime.datetime.now().time().strftime('%I:%M %p')
...
frame = tkinter.Frame(window,width= 100, height= 100, bg= back_color)
frame.grid(padx=20, pady=20)
# frame.pack(expand = True)
# window.geometry("1033x510")
# window.geometry("1920x1080")
window.maxsize(1050,540)
window.minsize(1050,540)


##---Label Creation WIth Entry
...
l12 = tkinter.Label(frame, text="Developed by Ravi Gupta (https://mrravigupta.com/)",fg='blue',
                    bg=back_color, font=('Verdana', 8,'bold'))
l12.grid(row=8, column=0,columnspan=2)
...
b1 = tkinter.Button(frame, text="Add Item", bg="#FCD16F", fg=button_font_color, font=('Arial', 12 ), command=add_item )
b1.grid(row=4, column=3, pady=20)


c = ('sno', 'desc', 'qty', 'price', 'total')

scrollbary = Scrollbar(window, orient=VERTICAL) ## Adding Vertical Scroll Bar
...
scrollbary.place(relx=0.964, rely=0.367, width=22, height=201)


tree.heading('sno', text='S.No.')
tree.heading('desc', text='Description',anchor=tkinter.W)
tree.heading('qty', text='Quantity')
tree.heading('price', text='Unit Price')
tree.heading('total', text='Total')

tree.column("sno",anchor=tkinter.CENTER,stretch= NO)
tree.column("qty",anchor=tkinter.CENTER)
tree.column("price",anchor=tkinter.CENTER)
tree.column("total",anchor=tkinter.CENTER)
...
# ----Delete Item Button
b4 = tkinter.Button(frame, text="Delete Item",bg="#EC5E3C",fg=button_font_color, font=button_font_size, command=delete_item)
b4.grid(row=6, column=0, columnspan=2, sticky="news", padx=10, pady=5)

# ----Save Invoice Button
b2 = tkinter.Button(frame, text="Generate Invoice", bg="#86BD3C",fg=button_font_color, font=button_font_size, command=generate_invoice)
b2.grid(row=6, column=2, columnspan=2, sticky="news", padx=10, pady=5)

# ----New Invoice Button
b3 = tkinter.Button(frame, text="Create New Invoice", bg="#2789C6",fg=button_font_color, font=button_font_size, command=new_invoice)
