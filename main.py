...
def add_item_row():
    ...
    tree.insert('', serial, values=invoice_item)
...
def delete_item():
    ...
    for invoice_item in old_list:
        tree.insert('', 1000, values=invoice_item)
...
l12 = tkinter.Label(frame, text="Developed by Ravi Gupta (https://mrravigupta.com/)",
                    fg='blue', bg=back_color, font=('Verdana', 8,'bold'))
...
tree.column("sno",anchor=tkinter.CENTER)
